...
def to_24(context):
    ...
    taxonomy_args[0]["field_name"] = (
        taxonomy_args[0]["field_prefix"] or ""
    ) + taxonomy_args[0]["short_name"]  # noqa: E501

    taxonomy_args[1]["vocabulary_name"] = "collective.taxonomy.eeapublishertaxonomy"  # noqa: E501
    taxonomy_args[1]["short_name"] = "publisher"
    taxonomy_args[1]["field_name"] = (
        taxonomy_args[1]["field_prefix"] or ""
    ) + taxonomy_args[1]["short_name"]  # noqa: E501
    ...
    taxonomy_args[2]["field_name"] = (
        taxonomy_args[2]["field_prefix"] or ""
    ) + taxonomy_args[2]["short_name"]  # noqa: E501
    ...
    for new_args in taxonomy_args:
        ...
        try:
            ...
            logging.info("Column {0} already exists".format(new_args["field_name"]))  # noqa: E501
        ...
        add(
            "vocabulary",
            Record(field.TextLine(), safe_unicode(new_args["vocabulary_name"])),  # noqa: E501
        )  # noqa: E501
